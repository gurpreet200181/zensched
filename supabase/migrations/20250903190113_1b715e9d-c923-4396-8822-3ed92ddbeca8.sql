-- Fix the populate_daily_analytics_from_events function to count all busy event types correctly
...
-- Recalculate analytics for Gurpreet with the fixed function
